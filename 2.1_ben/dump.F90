...
USE commondata, ONLY: fileout,crddumplog,veldumplog,chgdumplog,fulldumplog, &
                      ...
                      quaimlog,quadpimlog, nsp, spectype 
...
open(37,file=fileout,status='unknown')
   ...
   write(37,*) crddumplog
   write(37,*) veldumplog
   write(37,*) chgdumplog, quadpimlog 
   write(37,*) cimlog, daimlog, quaimlog
   write(37,*) fulldumplog

!write out new cell matrix
   write(37,*)'Lattice' 
   write (37,*) boxlenx, boxleny, boxlenz
   write(37,*) hlab3(1,1),hlab3(2,1),hlab3(3,1)
   write(37,*) hlab3(1,2),hlab3(2,2),hlab3(3,2)
   write(37,*) hlab3(1,3),hlab3(2,3),hlab3(3,3)

! write out species and numbers 
  write(37,('(2X,20(A6,1X))')) (spectype(i),i=1,nspec)
  write(37,('(2X,20(i6,1X))')) (nsp(i),i=1,nspec)

   if(crddumplog) then
      write(37,*)'Coordinates' 
      do i=1,num
